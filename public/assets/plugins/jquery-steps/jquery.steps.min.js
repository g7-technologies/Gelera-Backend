! function(a, b) {
    ...
    function u(a, b, c, d) {
        if(d==4)
        {
            ...
            var x = document.getElementById("sender_phone_code").value;
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                ...
                f = '<li style="float:right"><button class="btn btn-success w-md waves-effect waves-light" type="submit" id="create_order" style="display:none">Create Order</button></li>';
